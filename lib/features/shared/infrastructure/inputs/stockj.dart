...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == StockError.values ) return 'Tiene que ser un número  mayor o igual a 0';
  ...
  StockError? validator(int value) {
    ...
    final isIntegetr = int.tryParse(value.toString()) ?? '-1';
    if(isIntegetr == -1) return StockError.format;
